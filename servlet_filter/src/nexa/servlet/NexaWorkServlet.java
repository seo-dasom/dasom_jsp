...
public class NexaWorkServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ArrayList<NexaTestVO> datas = new ArrayList<NexaTestVO>();
			
			NexaTestDAO dao = new NexaTestDAO();
			if(dao.isConnected()) {
				datas = (ArrayList<NexaTestVO>)dao.selectAll();
				...
				VariableList var_list = pdata.getVariableList();
				var_list.add("ErrorCode", -2);
				var_list.add("ErrorMsg", "DB Connection Fail");
			}
